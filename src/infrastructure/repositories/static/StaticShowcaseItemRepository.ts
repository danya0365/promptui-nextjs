...
const SHOWCASE_ITEMS: ShowcaseItem[] = [
  ...
  },
  {
    ...
    description:
      "Music Player UI พร้อม Waveform animation, Playlist management และ Dark theme",
    category: "dashboard",
    prompt:
      "Design a sleek music player dashboard with a vinyl record spin animation, real-time waveform visualizer, collapsible playlist sidebar, and glassmorphism player controls. Use a dark purple/midnight theme with neon accents.",
  ...
  },
  {
    ...
    description:
      "แอปปฏิทินแบบ Modern Clean UI พร้อม drag & drop events และ view switching",
    category: "productivity",
    prompt:
      "Create a modern calendar app interface with clean grid view, color-coded events, sidebar mini-calendar, view switcher (month/week/day), and floating create button. Use a clean material design inspired look with soft shadows.",
  ...
  },
  {
    ...
    description:
      "File Manager UI พร้อม Folder Grid, Breadcrumbs navigation และ Storage usage visualizer",
    category: "dashboard",
    prompt:
      "Build a cloud file manager dashboard with a folder grid layout, file list view with file type icons, breadcrumb navigation, sidebar storage meter, and drag-drop upload zone. Use a crisp, professional blue/white color scheme.",
  ...
  },
  {
    ...
    description:
      "แชทบอท UI (ChatGPT Style) พร้อม code highlighting และ streaming text effect",
    category: "dashboard",
    prompt:
      "Design a modern AI chat interface similar to ChatGPT. Include a sidebar for chat history, a main chat window with bubble messages, avatar icons, markdown support for code blocks with syntax highlighting, and a floating input area with send button. Use a clean dark mode theme.",
  ...
  },
  {
    ...
    description:
      "แอปจองที่เที่ยวแบบ Masonry Grid พร้อม Filter bar และ Map toggle button",
    category: "ecommerce",
    prompt:
      'Create a travel booking application with a masonry grid layout for location cards. Each card should feature a large image, location name, rating, dates, and price. Include a sticky top navigation with search bar, a horizontal scrollable category filter (Islands, Camping, etc.), and a floating "Show Map" button.',
  ...
  },
  {
    ...
    description:
      "แอปสอนทำอาหารพร้อม Interactive Ingredient Checklist และ Nutrition Chart",
    category: "mobile",
    prompt:
  ...
  },
  {
    ...
    description:
      "แกลเลอรี Prompt ดีไซน์ Neo-Brutalism ขอบดำหนา สีสันสดใสป๊อปๆ จัดเรียงซ้อนกันสไตล์คอมิกส์",
    category: "card",
    prompt:
...
The intelligence of tomorrow, with the clarity of now.`,
  ...
  },
  {
    ...
    description:
      "อินเตอร์เฟซการ์ดที่ได้รับแรงบันดาลใจจากศิลปะอิสลาม โทนสีเขียวมรกต ลวดลายเรขาคณิต และไฮไลท์สีทองหรูหรา",
    category: "card",
...
Spiritual, elegant, peaceful, timeless.`,
  ...
  },
  {
    ...
    description:
      "แพลตฟอร์มการเรียนรู้พื้นหลังกระดาษ Parchment พร้อมเนื้อหาคัดกรองจากคัมภีร์และการตีความเชิงวิชาการ",
    category: "landing",
...
Educational, sacred, respectful, scholarly.`,
  ...
  },
  {
    ...
    description:
      "อินเตอร์เฟซธีมกลางคืนที่เงียบสงบ ได้รับแรงบันดาลใจจากลานมัสยิดใต้แสงจันทร์และดวงดาว",
    category: "card",
...
Peaceful, reflective, spiritual night experience.`,
  ...
  },
  {
    ...
    description:
      "อินเตอร์เฟซที่ได้รับแรงบันดาลใจจากสถาปัตยกรรมมุสลิมในสเปน (Andalusian) โทนสี Terracotta และลวดลายกระเบื้องโมเสกที่สวยงาม",
    category: "landing",
...
Cultural, historical, artistic, majestic.`,
  ...
  },
  {
    ...
    description:
      "แดชบอร์ดสไตล์โมเดิร์นที่ผสมผสานความเชื่อระดับจิตวิญญาณเข้ากับเทคโนโลยีสมัยใหม่ โทนสีเขียวเข้มตัดทอง",
    category: "dashboard",
...
Calm, intelligent, inspiring.`,
  ...
  },
  {
    ...
    description:
      "อินเตอร์เฟซที่ได้รับแรงบันดาลใจจากโครงสร้างและรูปทรงเรขาคณิตของกะอ์บะฮ์ มุ่งเน้นความเรียบง่าย ทรงพลัง และความสงบทางจิตวิญญาณ",
    category: "card",
...
Sacred, powerful, minimalist, deeply spiritual.`,
  ...
  },
  {
    ...
    description:
      "อินเตอร์เฟซธีมเดือนรอมฎอนที่ได้รับแรงบันดาลใจจากโคมไฟ (Fanous) ที่เรืองแสงท่ามกลางคืนที่เงียบสงบ",
    category: "card",
...
Warm, spiritual, peaceful Ramadan night.`,
  ...
  },
  {
    ...
    description:
      "อินเตอร์เฟซที่หรูหราได้รับแรงบันดาลใจจากสถาปัตยกรรมพระราชวังออตโตมัน ใช้โทนสีเขียวมรกตและทอง พร้อมรูปทรงซุ้มประตูโค้ง",
    category: "card",
...
Royal, historical, majestic Islamic art.`,
  ...
  },
  {
    ...
    description:
      "อินเตอร์เฟซที่ได้รับแรงบันดาลใจจากห้องสมุดยุคทองของอิสลาม นำเสนอความรู้ในรูปแบบของต้นฉบับลายมือโบราณ (Manuscript) ที่ทรงคุณค่า",
    category: "card",
...
Scholarly, wise, intellectual, historical.`,
  ...
  },
  {
    ...
    description:
      "อินเตอร์เฟซแห่งอนาคตที่ได้รับแรงบันดาลใจจากจักรวาลวิทยาและเรขาคณิตอิสลาม นำเสนอความงามของความสมมาตรและแสงสว่างในห้วงอวกาศ",
    category: "card",
...
Spiritual, cosmic, intelligent, futuristic.`,
  ...
  {
    id: "showcase-098",
    title: "Islamic Spatial Intelligence Core",
    description:
      "Futuristic Islamic spatial interface inspired by Apple Vision Pro and Minority Report — the Kaaba as a central intelligence core with orbiting holographic knowledge cards",
    category: "dashboard",
    prompt:
      "Create a futuristic Islamic spatial interface inspired by Apple Vision Pro and Minority Report.\n\nConcept:\nThe Kaaba acts as the central intelligence core.\n\nVisual System:\n- Infinite dark space environment\n- Floating holographic cards orbiting around a luminous Kaaba-inspired geometric core\n- Transparent glass panels\n- Soft gold and white illumination\n- Sacred geometric energy patterns\n- Subtle volumetric light rays\n\nCard Design:\n- Floating holographic panels\n- Frosted glass material\n- Golden illuminated borders\n- Multi-layer expandable cards\n- Floating Arabic calligraphy headers\n- Dynamic depth hierarchy\n\nInteraction:\n- Cards orbit gently in 3D space\n- Expanding a card projects a larger holographic knowledge panel\n- Connected cards generate glowing geometric pathways\n\nMood:\nSacred technology.\nSpiritual intelligence.\nFuture Islamic civilization.",
    thumbnailUrl: "/thumbnails/islamic-spatial-intelligence.webp",
    tags: [
      "islamic",
      "spatial",
      "vision-pro",
