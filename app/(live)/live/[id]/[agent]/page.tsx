...
import { IslamicSpatialIntelligenceDemoKimi } from "@/src/presentation/components/demos/IslamicSpatialIntelligenceDemoKimi";
...
const LIVE_PREVIEW_COMPONENTS: Record<
  string,
  Partial<Record<AiModel, React.ComponentType>>
> = {
  "showcase-001": {
  ...
  "showcase-022": {
    "gemini-3.1-pro": FuturisticGlassmorphismDirectoryDemoGemini,
  },
  "showcase-023": { "gemini-3.1-pro": Retro90sTechMagazineDemoGemini },
  "showcase-024": {
    "gemini-3.1-pro": LuxuryMinimalEditorialDirectoryDemoGemini,
  },
  ...
  "showcase-032": {
    "gemini-3.1-pro": HighContrastEditorialDirectoryDemoGemini,
  },
  "showcase-033": {
    "gemini-3.1-pro": DramaticFuturisticTechDirectoryDemoGemini,
  },
  ...
  "showcase-086": {
    "gemini-3.1-pro": GodLevelHolographicIntelligenceDemoGemini,
  },
  ...
  "showcase-097": {
    "gemini-3-flash": IslamicCosmologyDemoGemini,
...
export async function generateMetadata({
  params,
}: LivePreviewPageProps): Promise<Metadata> {
      ...
      >
        <div style={{ textAlign: "center" }}>
          ...
          <p style={{ color: "#94a3b8", marginBottom: "0.5rem" }}>
            ...
            <strong>
              {modelInfo?.icon} {modelInfo?.label || modelId}
            </strong>
          </p>
          <p
            style={{
